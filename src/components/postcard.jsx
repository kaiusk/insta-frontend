...
export default function PostCard(props) {
    ...
    }, [likeAdded, likeRemoved, dispatch, postLikes]);
                  ...
                  {format(parseISO(props.post.creationTime), 'dd.mm.yyyy')}
                    ...
                    <div className="d-flex justify-content-between align-items-center">
                        <div className="card-title mt-4">
                            ...
                            >
                                <i aria-hidden="true"
                                   className={props.post.liking ? "fa-solid fa-heart-circle-minus mr-1" : "fa-solid fa-heart-circle-plus mr-1"}></i>
                                {postLikes}
                            </button>
                        </div>
                        ...
                        <div className="card-title mt-4">
                            ...
                            >
                                <i aria-hidden="true" className="fa-regular fa-comments mr-1"></i>
                                {props.post.comments}
                            </button>
                        </div>
                    </div>
